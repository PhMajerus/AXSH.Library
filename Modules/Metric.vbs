...
Private Const ErrSource = "Metric module"
...
Public Function Parse(strNumber)
	...
	NumberRegex.Pattern = "^(([-+]?\d*)(\.\d*)?)([eE]([-+]?\d+))?([yzafpnu\xB5mcdhkMGTPEZY]|da)?$"
	' SubMatches:           [  0 = number      ][ 3=scient.exp. ][      5 = symbol             ]
	'                        [ 1=int. ][2=dec.]      [4=E.num.]
