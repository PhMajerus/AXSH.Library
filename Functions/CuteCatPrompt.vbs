...
Function CuteCatPrompt
	Dim CSI
	CSI = Chr(27)&"["
	CuteCatPrompt = CSI&"m" & vbCrLf & _
		" "&ChrW(&h039B)&CSI&"91mc"&ChrW(&h00F4)&ChrW(&h0254)&CSI&"m" & vbCrLf & _
		CSI&"4;9m("&CSI&"29;24m'"&CSI&"33m"&ChrW(&h2022)&CSI&"m'"&CSI&"4;9m)"&CSI&"m  " & AXSH.Location.Path & vbCrLf & _
